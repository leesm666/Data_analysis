...
# 캐릭터(스프라이트) 불러오기
character = pygame.image.load("C:\\Users\\이승미\\OneDrive\\바탕 화면\\Pythonworkspace\\pygame_basic\\character.png")
...
# 적 enemy 캐릭터
enemy = pygame.image.load("C:\\Users\\이승미\\OneDrive\\바탕 화면\\Pythonworkspace\\pygame_basic\\enemy.png")
